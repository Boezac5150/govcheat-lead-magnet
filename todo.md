...
## Phase 11 — Advanced Contract Filtering & Sorting

- [x] Add filter UI component (type, value, difficulty, agency, set-aside)
- [x] Add sort options (value, deadline, difficulty, newest)
- [x] Implement filter state management in Contracts page
- [x] Create backend filter/sort endpoints
- [x] Test filtering and sorting functionality
- [x] Deploy filtering feature live
